...
const _updateProduct = (id, name, price) => {
    return db('products').update({ name: name, price: price }, ["id", "name", "price"]).where({id});
}
...
module.exports = {
    _getAllProducts, _getOneProduct, _addProduct, _updateProduct, _searchProduct, _deleteProduct
};